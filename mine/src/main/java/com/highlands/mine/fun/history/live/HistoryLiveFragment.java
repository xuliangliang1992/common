 ...
 */
@Route(path = RouterUrl.MINE_FRAGMENT_HISTORY_LIVE)
public class HistoryLiveFragment extends BaseRefreshFragment<PolicyBean, HistoryLivePresenter> implements HistoryLiveContract.View {
    private ObservableArrayList<PolicyBean> mBeans;
    private HistoryFragmentBinding mBinding;
    private HistoryLiveAdapter mHistoryAdapter;

    static HistoryLiveFragment newInstance() {
    ...
    public void initView(View view) {
        ...
        mHistoryAdapter = new HistoryLiveAdapter();
...
//        mActivity.showInitLoadView();
    ...
    public void setPresenter() {
        mPresenter = new HistoryLivePresenter(this);
    }
