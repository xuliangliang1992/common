...
import com.highlands.train.databinding.CartFragmentBinding;
import com.highlands.train.http.response.CartBean;
import com.highlands.train.http.response.GoodBean;
import com.highlands.train.view.SlideExpandableRecyclerView;
 ...
 */
@Route(path = RouterUrl.TRAIN_FRAGMENT_CART)
